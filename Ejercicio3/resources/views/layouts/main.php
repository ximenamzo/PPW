...
<head>
    ...
    <link rel="stylesheet" href="/PPW/Ejercicio3/resources/css/style.css">
    <link rel="stylesheet" href="/PPW/Ejercicio3/resources/css/bootstrap.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.3/font/bootstrap-icons.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300&display=swap" rel="stylesheet">
    <link rel="icon" type="image/x-icon" href="/PPW/Ejercicio3/resources/img/favicon.ico">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <?php } else { ?>
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/PPW/Ejercicio3/resources/views/auth/login.php">Iniciar sesión</a></li>
...
?>
    ...
    <script src="/PPW/Ejercicio3/resources/js/bootstrap.js"></script>
    <script src="/PPW/Ejercicio3/resources/js/bundle.js"></script>
    <script src="/PPW/Ejercicio3/resources/js/popper.js"></script>
    <script src="/PPW/Ejercicio3/resources/js/jquery.js"></script>
    <script src="/PPW/Ejercicio3/resources/js/app.js"></script>
<?php 
    if($script != ''){
        echo '<script src="/PPW/Ejercicio3/resources/js/'.$script.'.js"></script>';
    }
    }
