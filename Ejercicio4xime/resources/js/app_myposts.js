                    ...
                    for(let post of mpresp){
                        html += `
                            <tr>
                                ...
                                <a href="#" class="link-primary mx-1" onclick="app_myposts.modalShow(${post.id}, 'staticBackdropEdit${post.id}')">
                                    <i class="bi bi-pencil-square"></i></a>
                                    <div class="modal fade" id="staticBackdropEdit${post.id}" data-bs-backdrop="static" data-bs-keyboard="false" 
                                    tabindex="-1" aria-labelledby="staticBackdropEditLabel${post.id}" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
