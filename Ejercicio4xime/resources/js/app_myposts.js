const app_myposts = {
    ...
    url : "/PPW/Ejercicio4xime/app/app.php",
                ...
                if(mpresp.length > 0){
                    ...
                    for(let post of mpresp){
                        html += `
                            <tr>
                                <td>
                                    <a href="#" id="mi-elemento" data-bs-toggle="popover" 
                                        data-bs-content="${post.body}">
                                        ${post.title}
                                    </a>
                                </td>
                                <td  style="text-align:rigth;vertical-align:middle;">${post.created_at}</td>
                                <td>
